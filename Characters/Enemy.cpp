...
Enemy::Enemy(std::string textureName, sf::Vector2f texturePos, sf::Vector2f position, sf::Vector2f v, int shootTimer,
             bool isActive, int hearts, EnemyType e, sf::Vector2f projectileSpeed, sf::Rect<float> hitbox) : Character(

        textureName, texturePos, position, v, shootTimer, hearts), isActive(isActive), enemyType(e), projectileSpeed(projectileSpeed),
                                                                                     hitbox(hitbox){
